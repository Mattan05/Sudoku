error id: file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/solver/MySudokuSolver.java:java/lang/IndexOutOfBoundsException#
file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/solver/MySudokuSolver.java
empty definition using pc, found symbol in pc: java/lang/IndexOutOfBoundsException#
...
public class MySudokuSolver implements SudokuSolver {
    ...
    public void set(int row, int col, int digit) {
        if(row < 0 || row > 8 || col < 0 || col > 8){
            throw new IndexOutOfBoun@@dsException();
        }
        if(digit < 0 || digit > 9){
