error id: file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/view/SudokuGUIController.java:javax/swing/JOptionPane#showConfirmDialog().
file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/view/SudokuGUIController.java
empty definition using pc, found symbol in pc: javax/swing/JOptionPane#showConfirmDialog().
...
public class SudokuGUIController {
    ...
    private void createWindow(String title, MySudokuSolver solver){
        ...
        clear.addActionListener(e -> {
            solver.clearAll();
            JOptionPane.showConfirmD@@ialog(frame, "Rutorna är tömda");
        });
