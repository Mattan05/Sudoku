error id: file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/view/SudokuGUIController.java:_empty_/MySudokuSolver#set#
file:///C:/Users/Mattis/Documents/datateknik/sudoku/src/view/SudokuGUIController.java
empty definition using pc, found symbol in pc: _empty_/MySudokuSolver#set#
...
public class SudokuGUIController {
    ...
    private void readGrid(MySudokuSolver solver, JFrame frame){
        for(int r = 0; r < 9; r++){
            for(int c = 0; c < 9; c++){
                ...
                if(!text.isEmpty()){ 
                   try{
                        ...
                        JOptionPane.showMessageDialog(frame, "Fel: Ogiltig siffra i rutan!", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                   }
                }else{
                    solver.set(r, c, 0);
    ...
    private void updateGrid(int[][] grid){
        for(int r = 0; r < 9; r++){
            for(int c = 0; c < 9; c++){
                if(grid[r][c] == 0) {
                    cells[r][c].setText("");   // visa tom ruta
                } else {
